...
(function() {
  ...
  // Extract tool name from path or title
  ...
  function sendTelemetry() {
    ...
    if (durationSeconds > 2) { // Only track if they stayed at least 2 seconds
  ...
  // Send data when user leaves the page or hides the tab
